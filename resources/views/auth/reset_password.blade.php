        ...
        <div class="col-lg-7 vh-100 p-0">
            <div class="px-5 w-100 h-100">
                <div class="d-flex align-items-center justify-content-center w-100 h-100">
                    <form action="/reset_password" method="post" class="responsive-width">
                        @csrf
                        <div class="mb-5">
                            <div class="mb-2">
                        ...
                        <div>
                            <div class="mb-4">
                                ...
                                <input type="password" placeholder="كلمة المرور" class="form-control p-2"
                                    name="password">
                            </div>
                            <div class="mb-4">
                                <label for="" class="mb-1"> تأكيد كلمة المرور </label>
                                <input type="password" placeholder="تأكيد كلمة المرور"
                                    class="form-control p-2" name="password_confirmation">
                            </div>
                            ...
                            <div class="mb-4">
                                <button type="submit" class="btn btn-primary prm w-100 p-2"> تغيير كلمة المرور </button>
                            </div>
                        </div>
                    </form>
                </div>
