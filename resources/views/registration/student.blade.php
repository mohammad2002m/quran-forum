            ...
            <form action="/registration/student" method="post">
                ...
                <section>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" value="{{ old('name') }}" class="form-control " placeholder="الاسم الكامل"
                            name="name">
                    </div>
                ...
                <div class="text-center">
                    <button type="submit" class="btn btn-primary"> سجل بالملتقى </button>
                </div>
